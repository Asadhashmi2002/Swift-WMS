...
export const Header: React.FC<HeaderProps> = ({ title, onSettingsClick }) => {
  ...
  return (
    <header className="h-16 bg-[var(--color-surface)] border-b border-[var(--color-border)] flex items-center justify-between px-4 sm:px-6">
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        <h1 className="text-lg sm:text-xl font-semibold text-[var(--color-text)] truncate max-w-[60vw]">
          {title}
        </h1>
      </div>
